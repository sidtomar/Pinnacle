...
function DoctorStackNavigator() {
  return (
    <DoctorStack.Navigator screenOptions={{ headerStyle: { backgroundColor: NAVY }, headerTintColor: '#fff', headerTitleStyle: { fontWeight: '700' } }}>
...
export default function AppNavigator() {
  return (
    ...
    >
      ...
      <Tab.Screen name="Content"   component={ContentFeedScreen}    options={{ title: 'Content Library' }} />
