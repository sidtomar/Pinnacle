...
MOCK_LIBRARY = {
    "GLP-1": {
        ...
        "summary": (
            ...
            "confirms that GLP-1 receptor agonists (GLP-1 RAs) deliver superior glycaemic control compared "
            "to DPP-4 inhibitors, with an HbA1c reduction of −1.8% versus −1.1% (p<0.001). Semaglutide "
            "1 mg weekly leads the class, demonstrating a 6.2 kg weight reduction at 52 weeks and a 33% "
            "reduction in major adverse cardiovascular events (MACE) in SUSTAIN-6 extension data.\n\n"
            "Critically for Indian practice, three Indian cohort studies (combined n=2,840) confirm that "
            "GLP-1 RAs reduce HbA1c by 1.6% in patients with BMI 23–27 — the lean-overweight range common "
            "in South Asian T2DM — validating that Western trial efficacy translates to Indian populations. "
            "Dulaglutide shows particular strength in patients with eGFR 30–60, offering renal protection "
            "alongside glycaemic benefit.\n\n"
            "The 2025 ADA/EASD guidelines now recommend GLP-1 RAs as first-line therapy alongside metformin "
            "for patients with established cardiovascular disease, heart failure, or chronic kidney disease. "
            "Once-weekly formulations achieve 94% patient adherence versus 71% for daily injections, making "
            "them the preferred choice for complex patients. Combination with SGLT2 inhibitors provides "
            "additive cardiovascular and renal benefit. Key takeaway: for Indian T2DM patients with "
            "cardiovascular risk factors, GLP-1 RAs should be initiated early — the evidence is robust, "
            "the Indian data is available, and adherence is manageable."
        ),
        "key_findings": [
    ...
    "SGLT2": {
        ...
        "summary": (
            "Three-year follow-up data from EMPEROR-Reduced and DAPA-HF confirm SGLT2 inhibitors as the "
            "most significant advance in heart failure management in a decade. Empagliflozin and "
            ...
            "observed irrespective of diabetes status — a landmark finding that transformed HF guidelines.\n\n"
            ...
            "status. A meta-analysis of 94,820 patients across T2DM, HF, and CKD populations confirms a "
            "30% reduction in first HF hospitalisation (HR 0.70) and 14% reduction in CV death (HR 0.86), "
            "consistent across all subgroups.\n\n"
            "For Indian clinicians, the Indian HF Registry 2024 (n=1,240) provides real-world validation: "
            "empagliflozin and dapagliflozin achieve a 27% reduction in 30-day readmission rates. "
            "Renal protection is an additional benefit — SGLT2 inhibitors slow eGFR decline by 1.6 "
            "mL/min/year versus placebo. The safety profile is well-characterised: genital infections "
            "(3.1x risk, manageable with hygiene counselling) and minimal DKA risk in non-diabetic HF "
            "patients. Key takeaway: every HF patient in your clinic — diabetic or not — should now be "
            "considered for SGLT2 inhibitor therapy. Failure to prescribe requires active justification."
        ),
        "key_findings": [
    ...
    "PCOS": {
        ...
        "summary": (
            ...
            "myo-inositol and d-chiro-inositol showed superior menstrual regularity at 6 months (78% vs "
            "64% with metformin) and improved pregnancy rates in women seeking fertility (34% vs 29%).\n\n"
            "For Indian gynaecologists, the most clinically relevant finding is efficacy across BMI ranges. "
            "Lean PCOS — defined as BMI <23 — represents 20–30% of Indian PCOS cases but is often "
            "undertreated due to perceived metformin contraindication in non-obese patients. Indian cohort "
...
def _generic_content(topic: str, specialty: str, therapy_area: str) -> dict:
    ...
    return {
        ...
        "summary": (
            ...
            f"across South Asian populations, with adverse events manageable in the majority of cases. "
            f"Key takeaway: Indian {specialty.lower()} patients stand to benefit from updated {therapy_area} "
            f"treatment protocols — review your current patient cohort against 2025 guidelines and "
            f"identify candidates for guideline-concordant combination therapy."
        ),
        "key_findings": [
