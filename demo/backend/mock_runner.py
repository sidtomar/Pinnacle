...
def run_mock_pipeline(topic: str, specialty: str, therapy_area: str,
    ...
    for i, src in enumerate(sources):
        ...
        # ── Per-paper 200-300 word clinical summary ───────────────────────────
        # Anchored on this paper's UNIQUE key finding (src_snippet) so every
        # card gets a distinct summary rather than the topic-level boilerplate.
